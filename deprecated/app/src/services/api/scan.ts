...
export const scanApi = {
   ...
   */
  async scanText(content: string): Promise<ScanResult> {
    return apiClient.post<ScanResult>('/scan/text', { content });
  },
  ...
  async scanImage(imageData: {
    ...
    return apiClient.post<ScanResult>('/scan/image', { 
